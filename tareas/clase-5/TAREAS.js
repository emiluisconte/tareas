...
/* ASI LO HICE YO. ESTA MAL. NO FUNCIONA


const MesesEnElAno = 12

function calcularSalarioMensual(salarioAnual){
  let salarioMensual
  return salarioMensual = salarioAnual/MesesEnElAno
}

document.querySelector("#calcular-salario-mensual").onclick = calcularSalarioMensual(salarioAnual) //NO PUEDO ASIGNAR UNA FUNCION EN onclick, osea no poner (). SOLO FUNCIONA SI LA EJECUTO, OSEA salarioMensual
